...
var ListItem = /** @class */ (function () {
    ...
    ListItem.prototype.handleClick = function (e, attrs) {
        ...
        var el = e.target;
        var isLeftContentClick = (0, _shared_1.getClosest)(el, ".".concat(_shared_1.Classes.LIST_ITEM_CONTENT_LEFT));
        var isRightContentClick = (0, _shared_1.getClosest)(el, ".".concat(_shared_1.Classes.LIST_ITEM_CONTENT_RIGHT));
